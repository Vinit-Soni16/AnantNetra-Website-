...
const DEFAULT_GLOW_COLOR = '0, 153, 255';
...
const OurVision: React.FC<BentoProps> = ({
  textAutoHide = true,
  enableStars = true,
      ...
      <style dangerouslySetInnerHTML={{
        __html: `
          .bento-section {
            ...
            --border-color: #2e304e;
            --background-dark: #000310;
            --white: hsl(0, 0%, 100%);
          --blue-primary: rgba(0, 102, 255, 1);
          --blue-glow: rgba(0, 102, 255, 0.2);
          --blue-border: rgba(0, 102, 255, 0.8);
